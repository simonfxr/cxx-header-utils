...
#define HU_MACH_MIPS_P 0
#define HU_MACH_PPC_P 0
...
#    endif
  ...
  defined(__mips64)
#    undef HU_MACH_MIPS_P
#    define HU_MACH_MIPS_P 1
#    ifndef HU_INTERNAL_BITS
...
#if HU_MACH_MIPS_P
#    define HU_MACH_MIPS 1
#endif

#if HU_MACH_X86_P + HU_MACH_ARM_P + HU_MACH_MIPS_P + HU_MACH_PPC_P != 1
